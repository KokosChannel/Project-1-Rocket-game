...
function startGame() {
    // Hier kommt der Code, der dein Spiel startet
    console.log("Das Spiel beginnt jetzt!");
    ...
    //Visuelle Anpassungen der HTML-Seite, wenn das Spiel verloren wird, i.e. bei Kollision von Rakete & Ufo.
   ...
   //Erfassen der Punkte des Spielers
   function updatePoints() {
    //Ausgang = 0 Punkte. Die aktualisierten Punkte werden auf der HTML-Seite eingefügt.
    ufosDestroyed = ufosDestroyed + 1;
    document.getElementById("pointsReached").textContent = ufosDestroyed;

    //Definition der Zielpunkte & optische Änderungen der HTML-Seite bei Sieg.
    if (ufosDestroyed == 10) {
        document.getElementById("infoBox").innerHTML = "YOU WON";
        document.getElementById("infoBox").style.backgroundColor = "green"
    ...
    //Wahl des Gegners. Bei Klick auf den jeweiligen Button soll die Ressource getauscht werden.
    //function choseMelanie() {

   // }

   // function chosePagano() {
//      ufo = PIXI.Sprite.from('assets/ufopagano.png');
   // }

   // function choseCavalla()